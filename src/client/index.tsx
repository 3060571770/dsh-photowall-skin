...
const zh = {
  ...
  'upload.error.ext': '仅支持 JPG、PNG 或 WebP 图片',
  'upload.error.size': '图片不能超过 12 MB',
  'upload.error.connection': '上传连接失败',
  ...
  'palette.preset-original': '原始暖棕',
  'palette.preset-neutral': '中性灰',
  'palette.preset-blue': '静谧蓝',
  'palette.preset-forest': '森林绿',
  'palette.common': '常用颜色',
...
const en = {
  ...
  'upload.error.ext': 'Only JPG, PNG or WebP images are supported',
  'upload.error.size': 'Image cannot exceed 12 MB',
  'upload.error.connection': 'Upload connection failed',
  ...
  'palette.preset-original': 'Original Warm Brown',
  'palette.preset-neutral': 'Neutral Gray',
  'palette.preset-blue': 'Serene Blue',
  'palette.preset-forest': 'Forest Green',
